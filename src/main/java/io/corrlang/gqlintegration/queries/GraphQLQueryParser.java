...
import io.corrlang.gqlintegration.syntax.parser.GraphQLQueryBaseListener;
import io.corrlang.gqlintegration.syntax.parser.GraphQLQueryLexer;
...
class GraphQLQueryParser extends GraphQLQueryBaseListener {
    ...
    public GraphQLQuery parse() throws IOException, GraphQueryErrorMessage {
        ...
        io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser parser = new io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser(new CommonTokenStream(lexer));
    ...
    @Override
    public void exitDocument(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.DocumentContext ctx) {
    ...
    @Override
    public void enterOperationDefinition(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.OperationDefinitionContext ctx) {
    ...
    @Override
    public void exitOperationDefinition(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.OperationDefinitionContext ctx) {
    ...
    @Override
    public void enterVariableDefinition(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.VariableDefinitionContext ctx) {
    ...
    @Override
    public void exitVariableDefinition(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.VariableDefinitionContext ctx) {
    ...
    @Override
    public void enterOperationType(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.OperationTypeContext ctx) {
        switch (ctx.getText()) {
            case "subscription":
    ...
    @Override
    public void enterArgument(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ArgumentContext ctx) {
    ...
    @Override
    public void exitArgument(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ArgumentContext ctx) {
    ...
    @Override
    public void enterSelectionSet(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.SelectionSetContext ctx) {
        if (state.peek().equals(State.OPERATION)) {
    ...
    @Override
    public void exitSelectionSet(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.SelectionSetContext ctx) {
    ...
    @Override
    public void enterField(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.FieldContext ctx) {
    ...
    @Override
    public void exitField(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.FieldContext ctx) {
    ...
    @Override
    public void enterTypeRef(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.TypeRefContext ctx) {
        this.currentIsMandatory = false;
        this.currentIsSetValued = false;
    ...
    @Override
    public void enterListType(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ListTypeContext ctx) {
        this.currentIsSetValued = true;
    }

    @Override
    public void exitTypeRef(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.TypeRefContext ctx) {
    ...
    @Override
    public void enterVariable(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.VariableContext ctx) {
    ...
    @Override
    public void exitVariable(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.VariableContext ctx) {
    ...
    @Override
    public void enterStringValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.StringValueContext ctx) {
    ...
    @Override
    public void enterFloatValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.FloatValueContext ctx) {
        handleValue(ctx.getText());
    }

    @Override
    public void enterIntValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.IntValueContext ctx) {
        handleValue(ctx.getText());
    }

    @Override
    public void enterBooleanValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.BooleanValueContext ctx) {
        handleValue(ctx.getText());
    }

    @Override
    public void enterListValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ListValueContext ctx) {
        if (!this.state.peek().equals(State.STRICT_ERROR_SKIP) && !this.state.peek().equals(State.STRICT_DONE_SKIP)) {
    ...
    @Override
    public void exitListValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ListValueContext ctx) {
        if (this.state.peek().equals(State.ARRAY)) {
            this.state.pop();
        }
    }
    ...
    @Override
    public void enterObjectValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ObjectValueContext ctx) {
        if (!this.state.peek().equals(State.STRICT_ERROR_SKIP) && !this.state.peek().equals(State.STRICT_DONE_SKIP)) {
    ...
    @Override
    public void exitObjectField(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ObjectFieldContext ctx) {
        if (!this.state.peek().equals(State.STRICT_ERROR_SKIP) && !this.state.peek().equals(State.STRICT_DONE_SKIP)) {
    ...
    @Override
    public void exitObjectValue(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.ObjectValueContext ctx) {
    ...
    @Override
    public void enterName(io.corrlang.gqlintegration.syntax.parser.GraphQLQueryParser.NameContext ctx) {
        if (!this.state.peek().equals(State.STRICT_ERROR_SKIP) && !this.state.peek().equals(State.STRICT_DONE_SKIP)) {
